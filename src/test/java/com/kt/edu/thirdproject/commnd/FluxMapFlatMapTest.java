...
//    List<Member> customerList = List.of(new Member("gildong", "gildong@gmail.com"),
//            new Member("dooly", "dooly@gmail.com"));
//
//    @Test
//    public void transformUsingMap() {
//        //public final <V> Flux<V> map(Function<? super T,? extends V> mapper)
//        //Transform the items emitted by this Flux by applying a synchronous function to each item.
//        Flux<Member> customerFlux = Flux.fromIterable(customerList)
//                .map(customer -> new Member(customer.getName().toUpperCase(), customer.getEmail().toUpperCase()))
//                .log();
//
//        customerFlux.subscribe(System.out::println);
//
//        StepVerifier.create(customerFlux)
//                .expectNext(new Member("GILDONG","GILDONG@GMAIL.COM"))
//                //.expectNextCount(1)
//                .expectNext(new Member("DOOLY","DOOLY@GMAIL.COM"))
//                .verifyComplete();
//    }
//
//    @Test
...
//    }
//
//    private Function<Member, Publisher<? extends Member>> getFunction() {
//        return customer -> Mono.just(new Member(customer.getName().toUpperCase(), customer.getEmail().toUpperCase()));
//    }
//
//    @Test
